...
<template>
  <article class="TeamMember">
    <VTLink v-if="member.sponsor" class="sponsor" :href="`https://github.com/sponsors/${member.socials.github}`"
      no-icon>
    ...
    <div class="data">
      ...
      <p class="org">
        ...
        <span v-if="member.company" class="nowrap">
          @
          <VTLink v-if="member.companyLink" class="company link" :href="member.companyLink" :no-icon="true">
            {{ member.company }}
          </VTLink>
      ...
      <div class="profiles">
        ...
        <ul class="social-list">
          ...
          <li v-if="member.socials.github" class="social-item">
            <VTLink class="social-link" :href="`https://github.com/${member.socials.github}`" :no-icon="true">
              <VTIconGitHub class="social-icon" />
            </VTLink>
          </li>
          <li v-if="member.socials.x" class="social-item">
            <VTLink class="social-link" :href="`https://x.com/${member.socials.x}`" :no-icon="true">
              <VTIconX class="social-icon" />
            </VTLink>
          </li>
          <li v-if="member.socials.linkedin" class="social-item">
            <VTLink class="social-link" :href="`https://www.linkedin.com/in/${member.socials.linkedin}`"
              :no-icon="true">
              <VTIconLinkedIn class="social-icon" />
            </VTLink>
          </li>
          <li v-if="member.socials.codepen" class="social-item">
            <VTLink class="social-link" :href="`https://codepen.io/${member.socials.codepen}`" :no-icon="true">
